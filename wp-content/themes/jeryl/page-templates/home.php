...
<div class="about-section row">
					<div class="col-lg-6">
                        ...
                        <?php $homesocials = CFS()->get('home_social_section');
                         ...
                         ?>
								<li><a href="<?php echo $eachhomesocial['link'];  ?>" title=""><i class="<?php echo $eachhomesocial['faviconclass'];  ?>"></i></a></li>
                     <?php } ?>
            ...
            <div class="gallery-section row">
                  ...
                  <div class="gallery-col overlay2">
                    <!-- <img src="<?php //echo $videothumburl2; ?>" alt=""> -->
                     ...
                     <!--<a rel="gallery-1" href="<?php //the_field('second_youtube_video'); ?>" title=""
                      ...
                      <a rel="gallery-1" href="https://open.spotify.com/artist/1uEkI6eLZoDHxS49XsPRI7 <?php //the_field('second_image'); ?>" title=""
               ...
               <div class="col-lg-6 col-md-6 col-sm-6 mb-5">
                  <div class="gallery-col overlay2">
                     ...
                     <a rel="gallery-1" href="<?php the_field('fourth_image'); ?>" title=""
                        class="play-btn v2" data-fancybox="gallery"><i class="fa fa-plus"></i></a>
                  </div><!--gallery-col end-->
               </div>
			   <div class="col-lg-6 col-md-6 col-sm-5 mb-5">
                  <div class="gallery-col overlay2 wdthrt">
                     ...
                     <a rel="gallery-1" href="<?php the_field('second_image'); ?>" title=""
                        class="play-btn v2" data-fancybox="gallery"><i class="fa fa-plus"></i></a>
                  </div><!--gallery-col end-->
               </div>
